...
const About = () => {
  return (
    <div className={baseStyles["main-container"]}>
      <div className={baseStyles["sub-container"]}>
        <h1 className={baseStyles["title"]}>About GPT RPG</h1>
        <p className={baseStyles["subtitle"]}>
          This is a virtual RPG adventure game with an AI-powered Game Master.
        </p>
        <div className={baseStyles["info-section"]}>
          <div className={baseStyles["tech-container"]}>
            ...
            <ul className={baseStyles["tech-list"]}>
              ...
              <li className={baseStyles["tech-item"]}>TypeScript</li>
